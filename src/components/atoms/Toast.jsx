...
export const Toast = () => {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-9999 flex flex-col gap-2.5 max-w-[400px] pointer-events-none max-sm:bottom-2.5 max-sm:right-2.5 max-sm:left-2.5 max-sm:max-w-none">
      {notifications.map((notification) => (
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            ...
            <p className="m-0 text-sm leading-relaxed wrap-break-words font-medium">
