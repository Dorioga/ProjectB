...
export function TeacherProvider({ children }) {
  ...
  const saveElementStudentAnswer = useCallback(async (payload = {}) => {
    setLoadingTeachers(true);
    setErrorTeachers(null);
    try {
      const res = await teacherService.saveElementStudentAnswer(payload);
      return res;
    } catch (err) {
      setErrorTeachers(err);
      throw err;
  ...
  const saveStudentAnswer = useCallback(async (payload = {}) => {
    setLoadingTeachers(true);
    setErrorTeachers(null);
    try {
      const res = await teacherService.saveStudentAnswer(payload);
      return res;
    } catch (err) {
      setErrorTeachers(err);
      throw err;
  ...
  const getElementNotes = useCallback(async (payload = {}) => {
    setLoadingTeachers(true);
    setErrorTeachers(null);
    try {
      const res = await teacherService.getElementNotes(payload);
      return res;
    } catch (err) {
      setErrorTeachers(err);
      throw err;
  ...
  const getElementStudentResult = useCallback(async (payload = {}) => {
    setLoadingTeachers(true);
    setErrorTeachers(null);
    try {
      const res = await teacherService.getElementStudentResult(payload);
      return res;
    } catch (err) {
      setErrorTeachers(err);
      throw err;
